	...
	def __init__(
		...
		**ignored_kwargs
		...
		if format in ["wsj0", "vctk"]:
			dic_correspondence_subsets = {"train": "train", "valid": "valid", "test": "test"}
...
class SpecsDataModule(pl.LightningDataModule):
	def __init__(
		self, base_dir, format="wsj0", spatial_channels=1, batch_size=2,
	...
	def train_dataloader(self):
                #return DataLoader(
                print(f"Loaded data size: {len(self.train_set)}")  #CAIR
                return DataLoader(
