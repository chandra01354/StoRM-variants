...
###########################################################################################################################################
                ...
                sc_loss, mag_loss = multi_resolution_stft_loss(y_denoised, x)
                ...
                #print("weight, loss_denoiser, loss_score", weight, loss_denoiser, loss_score)
                #loss = (loss_denoiser + loss_score) + (0.1*((sc_loss))**1) + (0.1*((mag_loss))**1)
                #loss = (loss_denoiser + loss_score) + (weight**2) + mfcc_loss
                loss = (loss_denoiser + loss_score) + (sc_loss**2) + (mag_loss**2)#+ mfcc_loss
